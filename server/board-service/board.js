...
exports.updateDate = (id, data) => {
    ...
    return Board.updateOne({ _id: id }, { $set: data }, { runValidators: true })
}


exports.updateBoardDetails = (id, data) => {
 
    const request = Board.updateOne({ _id: id }, { $set: data }, { runValidators: true })
